    ...
    execute: function () {
      ...
      _export("VerticalMatchStrategy", VerticalMatchStrategy = class VerticalMatchStrategy {
        ...
        checkMatch(pieceA, pieceB) {
          ...
          var pieces = this.checkSinglePieceMatch(pieceA, grid);
          var matchesB = this.checkSinglePieceMatch(pieceB, grid);
...
//# sourceMappingURL=5a79afc889bcaa08450e33ad6ce9a8d388779e58.js.map