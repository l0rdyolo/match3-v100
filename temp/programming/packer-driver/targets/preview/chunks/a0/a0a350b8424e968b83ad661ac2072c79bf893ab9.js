      ...
      _export("MatchChecker", MatchChecker = (_dec = ccclass("MatchChecker"), _dec(_class = (_class2 = class MatchChecker {
        static SwapPiecePositions(pieceA, pieceB, posA, posB, gridMap) {
          ...
          return _asyncToGenerator(function* () {
            ...
            _this.highlightNeighbors(pieceB, gridMap, horizontalVisited, verticalVisited);
        ...
        static highlightNeighbors(currentPiece, gridMap, horizontalVisited, verticalVisited, depth, maxDepth) {
          if (depth === void 0) {
            depth = 0;
          }
          ...
          for (var _direction of this.verticalDirections) {
            this.visitNeighborWithDirection(currentPiece, gridMap, _direction, verticalVisited, depth, maxDepth);
          }
        }
...
//# sourceMappingURL=a0a350b8424e968b83ad661ac2072c79bf893ab9.js.map