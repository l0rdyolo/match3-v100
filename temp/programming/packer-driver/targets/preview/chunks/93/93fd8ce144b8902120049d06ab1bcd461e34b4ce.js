System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, CCInteger, PiecesPool, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, GridGenerator;
      ...
      _export("GridGenerator", GridGenerator = (_dec = ccclass('GridGenerator'), _dec2 = property(_crd && PiecesPool === void 0 ? (_reportPossibleCrUseOfPiecesPool({
        ...
        generateGrid() {
          ...
          for (var i = 0; i < this.GRID_ROW; i++) {
            ...
            for (var j = 0; j < this.GRID_ROW; j++) {
              var piece = this.piecesPool.getPieceFromPool(); // piece.setPosition((j * 100) - ((5/2) * 75), i * 100);
        ...
        getCenteredPosition(j, i) {
          ...
          var _j = j * this.PIECE_CONTENT_SIZE - this.GRID_ROW / 2 * (this.GRID_ROW / 3);
...
//# sourceMappingURL=93fd8ce144b8902120049d06ab1bcd461e34b4ce.js.map