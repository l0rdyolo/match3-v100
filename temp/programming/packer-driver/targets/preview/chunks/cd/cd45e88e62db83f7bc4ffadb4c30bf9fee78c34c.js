System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, Vec3, CCInteger, InteractionManager, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, GridGenerator;
      ...
      _export("GridGenerator", GridGenerator = (_dec = ccclass('GridManager'), _dec2 = property(CCInteger), _dec3 = property(CCInteger), _dec(_class = (_class2 = class GridGenerator extends Component {
        ...
        Generate() {
          ...
          return _asyncToGenerator(function* () {
            for (var row = 0; row < _this.height; row++) {} // for (let row = 0; row < this.GRID_ROW; row++) {
            //   this.grid[row] = [];
...
//# sourceMappingURL=cd45e88e62db83f7bc4ffadb4c30bf9fee78c34c.js.map