    ...
    execute: function () {
      ...
      _export("GridManager", GridManager = (_dec = ccclass("GridManager"), _dec(_class = class GridManager extends (_crd && SingletonComponent === void 0 ? (_reportPossibleCrUseOfSingletonComponent({
        ...
        handleSelection(pieceA, pieceB) {
          ...
          return _asyncToGenerator(function* () {
            //! IDEA : swap piece grid dönebilir.
            //! IDEA : selectionManager>applySelection() buraya taşınmalı
            ...
            if (matches.length > 0) {
              ...
              yield _this2.gravityHandler.applyGravity(_this2._grid); // await this.fillEmptySpaces(); 
            } else {
              yield _this2.SwapPieces(pieceA, pieceB);
            }
          })();
...
//# sourceMappingURL=afa96ce0aa54e91514c5bda779d2977517aaa261.js.map