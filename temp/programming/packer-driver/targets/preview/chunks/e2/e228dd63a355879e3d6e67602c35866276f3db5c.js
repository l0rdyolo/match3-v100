System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, SelectionManager, SliderManager, GravityHandler, MatchChecker, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _crd, ccclass, property, GameManager;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      GravityHandler = _unresolved_4.GravityHandler;
    }, function (_unresolved_5) {
      MatchChecker = _unresolved_5.MatchChecker;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("GameManager", GameManager = (_dec = ccclass('GameManager'), _dec2 = property(_crd && SelectionManager === void 0 ? (_reportPossibleCrUseOfSelectionManager({
        ...
        applySelection(pieceA, pieceB) {
          var _this = this;

          return _asyncToGenerator(function* () {
            if (_this.selectionManager.isSelectionValid()) {
        ...
        handleMatches(matches) {
          ...
          for (var piece of matches) {// piece.destroy();
...
//# sourceMappingURL=e228dd63a355879e3d6e67602c35866276f3db5c.js.map