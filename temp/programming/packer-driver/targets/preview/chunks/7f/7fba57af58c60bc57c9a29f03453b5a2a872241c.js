    ...
    execute: function () {
      ...
      _export("FollowCamera", FollowCamera = (_dec = ccclass('FollowCamera'), _dec2 = property({
        ...
        update(deltaTime) {
          ...
          var desiredPosition = this.target.worldPosition.clone().add(new Vec3(this.offsetX, this.offsetY, this.offsetZ));
...
//# sourceMappingURL=7fba57af58c60bc57c9a29f03453b5a2a872241c.js.map