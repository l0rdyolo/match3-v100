    ...
    execute: function () {
      ...
      _export("GridManager", GridManager = (_dec = ccclass("GridManager"), _dec(_class = class GridManager extends (_crd && SingletonComponent === void 0 ? (_reportPossibleCrUseOfSingletonComponent({
        ...
        SwapPieces(pieceA, pieceB) {
          ...
          pieceA.col = pb_col;
          pieceB.col = pa_col;
          this.grid[pa_row][pa_col] = null;
          this.grid[pb_row][pb_col] = null;
          this.grid[pa_row][pa_col] = pieceB;
          this.grid[pb_row][pb_col] = pieceA;
...
//# sourceMappingURL=343344d4b4f38c0f1c14b5f4dcf5882350bb0e8c.js.map