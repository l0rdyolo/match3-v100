              ...
              for (var col = 0; col < grid[0].length; col++) {
                for (var row = grid.length - 1; row >= 0; row--) {
                  ...
                  if (currentPiece.isEmpty && !belowPiece.isEmpty) {
                    currentPiece.col = belowPiece.col;
                    currentPiece.row = belowPiece.row; //! IDEA - parçaların yeni konumunun doğru güncelenmesi gerekiyor.
...
//# sourceMappingURL=7e0460c3a92fed391eef224aec0c0e5758b8c0ec.js.map