System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, EffectManager, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, GridGenerator;
        ...
        testEffects() {
          ...
          return _asyncToGenerator(function* () {
            yield (_crd && EffectManager === void 0 ? (_reportPossibleCrUseOfEffectManager({
              error: Error()
            }), EffectManager) : EffectManager).decreaseScale(_this.dummyCandy, 0.2, true);
            yield (_crd && EffectManager === void 0 ? (_reportPossibleCrUseOfEffectManager({
              error: Error()
            }), EffectManager) : EffectManager).downCellPosition(_this.dummyCandy, 1);
          })();
        }
...
//# sourceMappingURL=b381c90b43460df407b5d9e5ce01b0beeaff84d0.js.map