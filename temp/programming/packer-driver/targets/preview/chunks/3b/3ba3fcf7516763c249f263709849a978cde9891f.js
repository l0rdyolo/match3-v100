              ...
              for (var col = 0; col < grid[0].length; col++) {
                for (var row = grid.length - 1; row > 0; row--) {
                  ...
                  if (grid[row][col].node === null && grid[row + 1][col].node !== null) {
                    ...
                    promises.push(_this.movePieceToPosition(piece, new Vec3(col, row, 0))); // Parça hareketini asenkron olarak ekle
...
//# sourceMappingURL=3ba3fcf7516763c249f263709849a978cde9891f.js.map