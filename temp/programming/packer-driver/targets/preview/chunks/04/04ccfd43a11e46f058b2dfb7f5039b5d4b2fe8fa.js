      ...
      _export("GridManager", GridManager = (_dec = ccclass("GridManager"), _dec(_class = class GridManager extends (_crd && SingletonComponent === void 0 ? (_reportPossibleCrUseOfSingletonComponent({
        ...
        SwapPieces(pieceA, pieceB) {
          return _asyncToGenerator(function* () {
            ...
            pieceB.node = tempNode;
            pieceA.updatePosition();
            pieceB.updatePosition(); // await this.sliderManager.Slide(pieceA, pieceB);
        ...
        handleSelection(pieceA, pieceB) {
          ...
          return _asyncToGenerator(function* () {
            ...
            var [_pieceA, _pieceB] = yield _this.SwapPieces(pieceA, pieceB);
            console.log(_pieceA, _pieceB);
            return;
            var matches = yield _this.matchChecker.checkForMatches(_pieceA, _pieceB, _this.grid);

            if (matches.length > 0) {
              yield _this.deleteMatches(matches);
              yield _this.sleep(300);
              yield _this.gravityHandler.applyGravity(_this.grid);
              yield _this.sleep(1000); // await this.fillEmptySpaces();

              yield _this.sleep(900); //buraya bir sleep patlar
              ...
              yield _this.SwapPieces(pieceA, pieceB);
            }
          })();
        }
...
//# sourceMappingURL=04ccfd43a11e46f058b2dfb7f5039b5d4b2fe8fa.js.map