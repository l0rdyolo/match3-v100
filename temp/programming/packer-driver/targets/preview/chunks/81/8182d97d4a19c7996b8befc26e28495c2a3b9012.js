System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Color, Node, Vec3, SingletonComponent, GridGenerator, GameGlobal, SliderManager, MatchChecker, GravityHandler, PiecePool, _dec, _class, _crd, ccclass, property, GridManager;
      ...
      _export("GridManager", GridManager = (_dec = ccclass("GridManager"), _dec(_class = class GridManager extends (_crd && SingletonComponent === void 0 ? (_reportPossibleCrUseOfSingletonComponent({
        ...
        handleSelection(pieceA, pieceB) {
          ...
          return _asyncToGenerator(function* () {
            ...
            if (matches.length > 0) {
              _this2.deleteMatches(matches);

              yield _this2.gravityHandler.applyGravity();
              yield _this2.fillEmptySpaces();

              do {
                matches = yield _this2.matchChecker.checkForMatchesAfterGravity();
...
//# sourceMappingURL=8182d97d4a19c7996b8befc26e28495c2a3b9012.js.map