    ...
    execute: function () {
      ...
      _export("GridGenerator", GridGenerator = (_dec = ccclass('GridGenerator'), _dec2 = property(_crd && PiecesPool === void 0 ? (_reportPossibleCrUseOfPiecesPool({
        ...
        constructor() {
          ...
          this.interactionManager2 = new (_crd && InteractionManager === void 0 ? (_reportPossibleCrUseOfInteractionManager({
            error: Error()
          }), InteractionManager) : InteractionManager)();
        }
          ...
          return _asyncToGenerator(function* () {
            ...
            for (var row = 0; row < _this.GRID_ROW; row++) {
              ...
              var _loop = function* _loop(col) {
                ...
                var pieceFirstPosition = new Vec3(pieceLastPosition.x, 500);
...
//# sourceMappingURL=813d2f546f9f0d435d2df0987897265965123366.js.map