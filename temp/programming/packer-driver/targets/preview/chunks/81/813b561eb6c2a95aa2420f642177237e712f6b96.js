    ...
    execute: function () {
      ...
      _export("GridGenerator", GridGenerator = (_dec = ccclass('GridGenerator'), _dec2 = property(_crd && PiecesPool === void 0 ? (_reportPossibleCrUseOfPiecesPool({
        ...
        getCenteredPosition(j, i) {
          ...
          var _j = j * this.PIECE_CONTENT_SIZE - this.PIECE_CONTENT_SIZE * Math.round(this.GRID_ROW / 2);

          var _i = i * this.PIECE_CONTENT_SIZE - this.PIECE_CONTENT_SIZE * Math.round(this.GRID_ROW / 2);
...
//# sourceMappingURL=813b561eb6c2a95aa2420f642177237e712f6b96.js.map