    ...
    execute: function () {
      ...
      _export("GridGenerator", GridGenerator = (_dec = ccclass('GridGenerator'), _dec2 = property(_crd && PiecesPool === void 0 ? (_reportPossibleCrUseOfPiecesPool({
        ...
        generateGrid() {
          ...
          for (var i = 0; i < this.GRID_ROW; i++) {
            ...
            for (var j = 0; j < this.GRID_ROW; j++) {
              ...
              var _position = this.getCenteredPosition(j, i);
        ...
        getCenteredPosition(j, i) {
          ...
          var _j = j * this.PIECE_CONTENT_SIZE - this.GRID_ROW / 2 * (this.GRID_ROW * 0.75);

          var _i = i * this.PIECE_CONTENT_SIZE - this.GRID_ROW / 2 * (this.GRID_ROW * 0.75);
...
//# sourceMappingURL=217d7e3a2c6eb77993a7b27a8a6ca9dc433b84dc.js.map