        ...
        handleSelection(pieceA, pieceB) {
          ...
          return _asyncToGenerator(function* () {
            ...
            if (matches.length > 0) {
              ...
              var matchesTest = yield _this2.matchChecker.checkForMatches(pieceA, pieceB, _this2.grid);

              if (matchesTest.length > 0) {
                yield _this2.deleteMatches(matchesTest);
...
//# sourceMappingURL=8b21271a957a213c292e8696c44ab6b788d42d4d.js.map