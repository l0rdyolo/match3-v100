          ...
          return _asyncToGenerator(function* () {
            ...
            for (var row = 0; row < levelData.rows; row++) {
              for (var col = 0; col < levelData.cols; col++) {
                ...
                var asset = (_crd && InGameAssets === void 0 ? (_reportPossibleCrUseOfInGameAssets({
                  error: Error()
                ...
                if (asset) {
                  ...
                  var position = _this.getTilePosition(row, col, 64); // 64 örnek tile boyutu
...
//# sourceMappingURL=e6112b0c7c13e96fce9d931433315ccf74e9f5fb.js.map