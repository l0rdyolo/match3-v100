            ...
            for (var row = 0; row < _this2.gridHeight; row++) {
              for (var col = 0; col < _this2.gridWidth; col++) {
                ...
                if (piece.isEmpty) {
                  ...
                  piece.node.setPosition(new Vec3(piece.col, _this2.gridWidth * (_crd && GameGlobal === void 0 ? (_reportPossibleCrUseOfGameGlobal({
                    error: Error()
...
//# sourceMappingURL=90bdbe7980753993d520fb83d62a0f182627539e.js.map