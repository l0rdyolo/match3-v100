System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, MatchChecker, _dec, _class, _crd, ccclass, property, InteractionManager;
      ...
      _export("InteractionManager", InteractionManager = (_dec = ccclass('InteractionManager'), _dec(_class = class InteractionManager extends Component {
        ...
        onPieceClicked(event, piece) {
          if (this.firstSelectedPiece) {
            ...
            var pieceA = this.secondSelectedPiece;
            var pieceB = this.firstSelectedPiece;
...
//# sourceMappingURL=59b39afd4bfe6b702be80594cbfc31c878a5e6b8.js.map