  ...
  return {
    ...
    execute: function () {
      ...
      _export("FpCompare", FpCompare = class FpCompare {
         ...
         * small numbers equal.
         */
        constructor(epsilon, absThreshold) {
          if (epsilon === void 0) {
            epsilon = Number.EPSILON;
          }

          if (absThreshold === void 0) {
            absThreshold = Math.min(Math.abs(Number.MIN_VALUE), epsilon);
          }
        ...
        nearlyEqual(a, b) {
          ...
          var norm = Math.min(Math.abs(a) + Math.abs(b), Number.MAX_VALUE);
      ...
      _export("ComparerFactory", ComparerFactory = class ComparerFactory {
        ...
        static createComparer(type, customComparer) {
          ...
          var comparerConstructor = this.comparerMap.get(type);
...
//# sourceMappingURL=f9157635a041642a57ea7dd76607d694aee7ba51.js.map