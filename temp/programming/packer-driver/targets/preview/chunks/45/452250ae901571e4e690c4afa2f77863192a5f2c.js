      ...
      _export("MatchChecker", MatchChecker = (_dec = ccclass("MatchChecker"), _dec(_class = (_class2 = class MatchChecker {
        ...
        static checkMatches(currentPiece, gridMap, maxDepth) {
          ...
          return _asyncToGenerator(function* () {
            ...
            var horizontalVisited = _this2.collectMatches(currentPiece, gridMap, _this2.directions.horizontal, maxDepth);

            var verticalVisited = _this2.collectMatches(currentPiece, gridMap, _this2.directions.vertical, maxDepth);
...
//# sourceMappingURL=452250ae901571e4e690c4afa2f77863192a5f2c.js.map