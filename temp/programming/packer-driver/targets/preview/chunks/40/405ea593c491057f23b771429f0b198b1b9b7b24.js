System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Vec3, CCInteger, PiecesPool, InteractionManager, Piece, PieceTypes, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _crd, ccclass, property, GridGenerator;
          ...
          return _asyncToGenerator(function* () {
            for (var row = 0; row < _this.width; row++) {
              ...
              for (var col = 0; col < _this.height; col++) {
                ...
                piece.getComponent(_crd && Piece === void 0 ? (_reportPossibleCrUseOfPiece({
                  error: Error()
                }), Piece) : Piece).init(row, col, (_crd && PieceTypes === void 0 ? (_reportPossibleCrUseOfPieceTypes({
                  error: Error()
                }), PieceTypes) : PieceTypes).Normal);
              }
            }

            console.log(_this.grid); // for (let row = 0; row < this.GRID_ROW; row++) {
            //   this.grid[row] = [];
...
//# sourceMappingURL=405ea593c491057f23b771429f0b198b1b9b7b24.js.map