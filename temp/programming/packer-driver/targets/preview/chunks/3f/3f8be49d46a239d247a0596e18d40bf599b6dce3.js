    ...
    execute: function () {
      ...
      _export("MatchChecker", MatchChecker = (_dec = ccclass('MatchChecker'), _dec(_class = class MatchChecker {
        ...
        static checkMatchInDirection(grid, piece, row, col, direction) {
          ...
          var matchCount = 1 + this.countMatches(grid, pieceName, row, col, direction, -1) + // Count matches in the negative direction
        ...
        static countMatches(grid, pieceName, row, col, direction, step) {
          var matchCount = 0;
          var [i, j] = direction === Direction.Horizontal ? [row, col + step] : [row + step, col];
...
//# sourceMappingURL=3f8be49d46a239d247a0596e18d40bf599b6dce3.js.map