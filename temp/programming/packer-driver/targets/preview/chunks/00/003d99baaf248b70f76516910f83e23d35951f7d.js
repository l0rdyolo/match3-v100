    ...
    execute: function () {
      ...
      _export("GridGenerator", GridGenerator = (_dec = ccclass('GridGenerator'), _dec2 = property(_crd && PiecesPool === void 0 ? (_reportPossibleCrUseOfPiecesPool({
        ...
        getCenteredPosition(j, i) {
          ...
          var _j = j * this.PIECE_CONTENT_SIZE - this.PIECE_CONTENT_SIZE * 4; //(Math.round(this.GRID_ROW / 2))) )


          var _i = i * this.PIECE_CONTENT_SIZE - this.PIECE_CONTENT_SIZE * 4; //(Math.round(this.GRID_ROW / 2))) ) 
...
//# sourceMappingURL=003d99baaf248b70f76516910f83e23d35951f7d.js.map