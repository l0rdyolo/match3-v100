      ...
      _export("GridManager", GridManager = (_dec = ccclass("GridManager"), _dec(_class = class GridManager extends (_crd && SingletonComponent === void 0 ? (_reportPossibleCrUseOfSingletonComponent({
        ...
        handleSelection(pieceA, pieceB) {
          ...
          return _asyncToGenerator(function* () {
            ...
            if (matches.length > 0) {
              ...
              yield _this2.gravityHandler.applyGravity(); // Gravity işleminin tamamlanmasını bekle
              // // Gravity sonrası yeni eşleşmeleri kontrol et

              _this2.fillEmptySpaces();
              ...
              do {
                ...
                if (matches.length > 0) {
                  ...
                  yield _this2.gravityHandler.applyGravity(); // Yeni gravity işlemini uygula ve bekle
                }
        ...
        fillEmptySpaces() {
          ...
          for (var row = 0; row < this.gridWidth; row++) {
            for (var col = 0; col < this.gridHeight; col++) {
              ...
              if (piece.node === null) {
                ...
                this.node.addChild(newPieceNode); //! burayı piece sınıf içinde yapabiliriz
...
//# sourceMappingURL=4866a3fb98c179091b6690403e5268f3213dae43.js.map