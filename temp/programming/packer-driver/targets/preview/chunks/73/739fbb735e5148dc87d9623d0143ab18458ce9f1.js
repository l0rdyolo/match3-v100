  ...
  return {
    ...
    execute: function () {
      ...
      _export("MatchChecker", MatchChecker = (_dec = ccclass("MatchChecker"), _dec(_class = (_class2 = class MatchChecker {
        ...
        static highlightNeighbors(currentPiece, gridMap) {
          for (var {
            dx,
            dy
          } of this.directions) {
            ...
            if (neighbor) {
              if (neighbor.name === currentPiece.name) {
                ...
                if (sprite) {
                  sprite.color = new Color(150, 150, 255); // Set to white
                }

                this.highlightNeighbors(neighbor, gridMap);
              }
            }
          }
        }
...
//# sourceMappingURL=739fbb735e5148dc87d9623d0143ab18458ce9f1.js.map