  ...
  return {
    ...
    execute: function () {
      ...
      _export("MatchChecker", MatchChecker = (_dec = ccclass("MatchChecker"), _dec(_class = (_class2 = class MatchChecker {
        ...
        static highlightNeighbors(currentPiece, gridMap, visited, depth, maxDepth // Set an appropriate max depth to prevent stack overflow
        ) {
          if (visited === void 0) {
            visited = new Set();
          }
...
//# sourceMappingURL=e11886e565bcb09a5f5b3548b3527cb3c413905a.js.map