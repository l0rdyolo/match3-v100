      ...
      _export("Piece", Piece = class Piece {
        ...
        Shake(shakeAmount, duration) {
          ...
          return _asyncToGenerator(function* () {
            ...
            var originalPosition = _this2.node.getPosition();
            ...
            return new Promise(resolve => {
              tween(_this2.node).by(duration / 4, {
                ...
                (_this2$node = _this2.node) == null ? void 0 : _this2$node.setPosition(originalPosition);
                resolve();
              }).start();
            });
          })();
...
//# sourceMappingURL=b79b1722189921eac168b1a5325fd2b78d274785.js.map