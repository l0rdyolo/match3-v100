    ...
    execute: function () {
      ...
      _export("GravityHandler", GravityHandler = (_dec = ccclass('GravityHandler'), _dec2 = property(_crd && GridManager === void 0 ? (_reportPossibleCrUseOfGridManager({
        ...
        applyGravity(matches) {
          ...
          var col; // Sütunlarda kaç adet boşluk oluştuğunu hesapla
        ...
        applyGravityToCol(col, columnPieceCount) {
          var emptySpaces = columnPieceCount.get(col);
        ...
        applyGravityForSingleColumn(col, emptySpaces) {
          ...
          console.log(colActivePieces); // Yeni parçalara yer açılması için boş kalan üst alanları doldur
...
//# sourceMappingURL=725760050e170f64523e362ab4df3a8c02bcef4d.js.map