        ...
        handleSelection(pieceA, pieceB) {
          ...
          return _asyncToGenerator(function* () {
            ...
            if (matches.length > 0) {
              ...
              var emptyPieces = yield _this2.gravityHandler.applyGravity(_this2.grid);
              console.log(emptyPieces.length);
              yield _this2.sleep(1000);
              yield _this2.fillEmptySpaces(emptyPieces); // await this.sleep(900);
...
//# sourceMappingURL=c8b7d576a859931633166204f3685b54324c3455.js.map