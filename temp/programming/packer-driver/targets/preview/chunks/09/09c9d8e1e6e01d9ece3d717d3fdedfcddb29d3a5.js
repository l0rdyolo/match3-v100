        ...
        handleSelection(pieceA, pieceB) {
          ...
          return _asyncToGenerator(function* () {
            ...
            while (matches.length > 0) {
              ...
              yield _this.sleep(1000);
              yield _this.matchChecker.checkForMatchesAfterGravity(_this._grid);
            ...
            for (var row = 0; row < _this2.gridHeight; row++) {
              for (var col = 0; col < _this2.gridWidth; col++) {
                ...
                if (piece.isEmpty) {
                  ...
                  newPieceNode.getComponentInChildren(Sprite).color = _this2.getRandomColor();
...
//# sourceMappingURL=09c9d8e1e6e01d9ece3d717d3fdedfcddb29d3a5.js.map