            ...
            for (var row = 0; row < _this2.gridHeight; row++) {
              for (var col = 0; col < _this2.gridWidth; col++) {
                ...
                if (piece.isEmpty) {
                  ...
                  piece.ResetScale();
                  piece.node.setPosition(new Vec3(col, _this2.gridWidth * (_crd && GameGlobal === void 0 ? (_reportPossibleCrUseOfGameGlobal({
                    error: Error()
                  }), GameGlobal) : GameGlobal).PIECE_CONTENT_SIZE * 2, 0));
...
//# sourceMappingURL=10fb9c3838d1f61ca83a518bc89b5e79dc80e93d.js.map