  ...
  return {
    ...
    execute: function () {
      ...
      _export("EffectManager", EffectManager = (_dec = ccclass("EffectManager"), _dec(_class = class EffectManager extends Component {
        ...
        static animateRowFall(pieceProps, duration) {
          var _this = this;

          return _asyncToGenerator(function* () {
            var promises = pieceProps.map(pieceProps => {
              return _this.fallPieceToGridPosition(pieceProps.piece, pieceProps.targetPosition, delay, 10);
            });
...
//# sourceMappingURL=02fa20bb5a751b3d399d2562ed01051da449d128.js.map