            ...
            for (var row = 0; row < _this2.gridHeight; row++) {
              for (var col = 0; col < _this2.gridWidth; col++) {
                ...
                if (piece.isEmpty) {
                  ...
                  piece.setPosition(row, _this2.gridHeight + (_crd && GameGlobal === void 0 ? (_reportPossibleCrUseOfGameGlobal({
                    error: Error()
...
//# sourceMappingURL=bf8b9a9ba7f11afed5635fbd94dfc1b114394396.js.map