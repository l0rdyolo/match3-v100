  ...
  return {
    ...
    execute: function () {
      ...
      _export("SelectionManager", SelectionManager = (_dec = ccclass("SelectionManager"), _dec(_class = class SelectionManager extends (_crd && SingletonComponent === void 0 ? (_reportPossibleCrUseOfSingletonComponent({
        ...
        applySelection() {
          ...
          return _asyncToGenerator(function* () {
            ...
            if (_this.isSelectionValid()) {
              ...
              var _matches = yield _this.matchChecker.checkForMatches(_this.firstSelected, _this.secondSelected); //handle match
              ...
              if (_matches.length > 0) {
                (_crd && GridManager === void 0 ? (_reportPossibleCrUseOfGridManager({
                  error: Error()
                }), GridManager) : GridManager).getInstance().deleteMatches(_matches);

                _this.gravityHandler.applyGravity();
              } else {
                console.log("elsee");
                yield _this.sliderManager.Slide(_this.firstSelected, _this.secondSelected);
        ...
        //     this.firstSelected = null;
        //     this.secondSelected = null;
        //     console.log("Seçimler sıfırlandı");
        // }
        // cancelSelectio2n() {
        // if (this.firstSelected && this.firstSelected.node) {
        // this.firstSelected.ResetScale();
        // }
        // if (this.secondSelected && this.secondSelected.node) {
        // this.secondSelected.ResetScale();
        // }
        // this.firstSelected = null;
        // this.secondSelected = null;
...
//# sourceMappingURL=dc679baceb02e52854bb9111fd5c6577139c290f.js.map