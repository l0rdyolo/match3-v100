System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Color, Vec3, SingletonComponent, GridGenerator, GameGlobal, SliderManager, MatchChecker, GravityHandler, PiecePool, _dec, _class, _crd, ccclass, property, GridManager;
      ...
      _export("GridManager", GridManager = (_dec = ccclass("GridManager"), _dec(_class = class GridManager extends (_crd && SingletonComponent === void 0 ? (_reportPossibleCrUseOfSingletonComponent({
        ...
        handleSelection(pieceA, pieceB) {
          ...
          return _asyncToGenerator(function* () {
            ...
            var matches = yield _this2.matchChecker.checkForMatches(pieceA, pieceB);

            if (matches.length > 0) {
              yield _this2.deleteMatches(matches);
              yield _this2.gravityHandler.applyGravity();
              yield _this2.fillEmptySpaces();
              var afterMatches = yield _this2.matchChecker.checkForMatchesAfterGravity();
              console.log(afterMatches); // do {
...
//# sourceMappingURL=25461505cf23528253096676ff96bd19bb889f19.js.map