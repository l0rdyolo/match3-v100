  ...
  return {
    ...
    execute: function () {
      ...
      _export("FollowJoystick", FollowJoystick = (_dec = ccclass("FollowJoystick"), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(CCInteger), _dec5 = property(CCFloat), _dec6 = (_crd && Range === void 0 ? (_reportPossibleCrUseOfRange({
        ...
        followFinger(event) {
          var touchPos = this.canvasResolver.resolvePosition(event);
          var distance = Vec3.distance(this.touchStartPos, touchPos);

          if (distance > this.radius + this.followThreshold) {
            var newPos = new Vec3();
            Vec3.lerp(newPos, this.ring.getPosition(), touchPos, this.lerpSpeed);
            var calculateStickPosition = Vec3.subtract(new Vec3(), this.stick.position, this.ring.position);
...
//# sourceMappingURL=df1f07d8ea1b87d6090c75f039bfae1b8fb3bf15.js.map