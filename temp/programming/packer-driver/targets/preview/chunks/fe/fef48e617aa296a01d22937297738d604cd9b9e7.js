System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, Vec3, CCInteger, PiecesPool, InteractionManager, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, GridGenerator;
      ...
      _export("GridGenerator", GridGenerator = (_dec = ccclass('GridGenerator'), _dec2 = property(_crd && PiecesPool === void 0 ? (_reportPossibleCrUseOfPiecesPool({
        ...
        generateGrid() {
          ...
          return _asyncToGenerator(function* () {
            ...
            for (var i = 0; i < _this.GRID_ROW; i++) {
              var row = [];

              for (var j = 0; j < _this.GRID_ROW; j++) {
                var piece = _this.piecesPool.getPieceFromPool();

                var _position = _this.getCenteredPosition(j, i);

                console.log(_position);
                piece.setPosition(_position); // Add click event listener

                piece.on(Node.EventType.TOUCH_END, _this.onPieceClicked, _this);
                row.push(piece);
              }
...
//# sourceMappingURL=fef48e617aa296a01d22937297738d604cd9b9e7.js.map