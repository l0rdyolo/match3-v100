    ...
    execute: function () {
      ...
      _export("GridGenerator", GridGenerator = (_dec = ccclass('GridGenerator'), _dec2 = property(_crd && PiecesPool === void 0 ? (_reportPossibleCrUseOfPiecesPool({
        ...
        getCenteredPosition(j, i) {
          ...
          var _j = j * this.PIECE_CONTENT_SIZE - this.GRID_ROW / 2;

          var _i = i * this.PIECE_CONTENT_SIZE - this.GRID_ROW / 2;
...
//# sourceMappingURL=46b07b7f3babecfa8abebda5d016a711e24b5acf.js.map