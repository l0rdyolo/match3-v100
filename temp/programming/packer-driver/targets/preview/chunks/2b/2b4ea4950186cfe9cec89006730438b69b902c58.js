  ...
  return {
    ...
    execute: function () {
      ...
      _export("Piece", Piece = class Piece {
        ...
        updatePosition() {
          this.canSelect = false;
          var newX = this.col; //* GameGlobal.PIECE_CONTENT_SIZE;

          var newY = this.row; //* GameGlobal.PIECE_CONTENT_SIZE;
...
//# sourceMappingURL=2b4ea4950186cfe9cec89006730438b69b902c58.js.map