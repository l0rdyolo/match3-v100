        ...
        handleSelection(pieceA, pieceB) {
          ...
          return _asyncToGenerator(function* () {
            ...
            if (matches.length > 0) {
              ...
              var newMatches = yield _this2.matchChecker.checkForMatchesAfterGravity(_this2.grid);

              if (newMatches.length > 0) {
                _this2.logMatchesByGroups(newMatches);
              } else {
...
//# sourceMappingURL=d60254098a6866c6cae98ac87388d2a7734865de.js.map