            ...
            do {
              ...
              for (var col = 0; col < grid[0].length; col++) {
                for (var row = grid.length - 1; row >= 1; row--) {
                  ...
                  var belowPiece = grid[row - 1][col]; // Eğer aşağıdaki hücre boşsa ve yukarıdaki doluysa

                  if (belowPiece.isEmpty && !currentPiece.isEmpty) {
                    var key = belowPiece.row + "," + belowPiece.col;
                    ...
                    var _key = belowPiece.row + "," + belowPiece.col;

                    emptyPieceMap.delete(_key);
                  }
                }
              }
...
//# sourceMappingURL=1d1b3d562a210edee7a3d64e1ee35b2aca80fd30.js.map