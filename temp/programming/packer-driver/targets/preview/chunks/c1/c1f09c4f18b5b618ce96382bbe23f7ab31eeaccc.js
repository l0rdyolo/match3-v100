      ...
      _export("TouchEvents", TouchEvents = class TouchEvents {
        ...
        register(eventTypeOrEvents, handler) {
          if (Array.isArray(eventTypeOrEvents)) {
            for (var [eventType, _handler] of eventTypeOrEvents) {
              this.handlers.set(eventType, _handler);
              this.node.on(eventType, _handler, this);
            }
          } else {
        ...
        unregister(eventType) {
          var handler = this.handlers.get(eventType);
        ...
        registerAll() {
          for (var [eventType, handler] of this.handlers) {
...
//# sourceMappingURL=c1f09c4f18b5b618ce96382bbe23f7ab31eeaccc.js.map