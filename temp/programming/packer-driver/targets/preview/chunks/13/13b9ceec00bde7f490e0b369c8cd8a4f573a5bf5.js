    ...
    execute: function () {
      ...
      _export("GridGenerator", GridGenerator = (_dec = ccclass('GridGenerator'), _dec2 = property(_crd && PiecesPool === void 0 ? (_reportPossibleCrUseOfPiecesPool({
        ...
        getCenteredPosition(j, i) {
          ...
          var _j = j * this.PIECE_CONTENT_SIZE - this.PIECE_CONTENT_SIZE * Math.floor(this.PIECE_CONTENT_SIZE / 2);

          var _i = i * this.PIECE_CONTENT_SIZE - this.PIECE_CONTENT_SIZE * Math.floor(this.PIECE_CONTENT_SIZE / 2);
...
//# sourceMappingURL=13b9ceec00bde7f490e0b369c8cd8a4f573a5bf5.js.map