  ...
  return {
    ...
    execute: function () {
      ...
      _export("InteractionManager", InteractionManager = (_dec = ccclass("InteractionManager"), _dec(_class = class InteractionManager extends Component {
        ...
        onPieceClicked(event, piece, gridMap) {
          ...
          return _asyncToGenerator(function* () {
            if (_this.firstSelectedPiece) {
              ...
              if (diff.length() === 120) {
                yield _this.SwapPiecePositions(pieceA, pieceB, posA, posB, gridMap);

                if (_this.checkMatches(pieceA, pieceB, gridMap)) {
                  console.log("grid manager handle match");
                } else {
                  yield _this.SwapPiecePositions(pieceA, pieceB, posB, posA, gridMap);
                }
              }
        ...
        SwapPiecePositions(pieceA, pieceB, posA, posB, gridMap) {
          return _asyncToGenerator(function* () {
            (_crd && EffectManager === void 0 ? (_reportPossibleCrUseOfEffectManager({
              error: Error()
...
//# sourceMappingURL=b827ea59f198761d6375340c15e7c619e4ffba6a.js.map