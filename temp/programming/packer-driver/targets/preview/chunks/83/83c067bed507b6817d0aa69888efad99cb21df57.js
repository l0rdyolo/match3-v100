            ...
            for (var row = 0; row < _this2.gridHeight; row++) {
              for (var col = 0; col < _this2.gridWidth; col++) {
                ...
                if (piece.isEmpty) {
                  ...
                  _this2.node.addChild(newPieceNode);

                  newPieceNode.getComponentInChildren(Sprite).color = _this2.colors.yellow;
                  console.log(newPieceNode.position);
                  piece.col = col;
                  piece.row = row;
                  ...
                  piece.node.setPosition(new Vec3(piece.col * (_crd && GameGlobal === void 0 ? (_reportPossibleCrUseOfGameGlobal({
                    error: Error()
                  }), GameGlobal) : GameGlobal).PIECE_CONTENT_SIZE, _this2.gridWidth * (_crd && GameGlobal === void 0 ? (_reportPossibleCrUseOfGameGlobal({
                    error: Error()
...
//# sourceMappingURL=83c067bed507b6817d0aa69888efad99cb21df57.js.map