  ...
  return {
    ...
    execute: function () {
      ...
      _export("VersionDetector", VersionDetector = class VersionDetector extends (_crd && Detector === void 0 ? (_reportPossibleCrUseOfDetector({
         ...
         */
        getVersionRegex() {
          var browserRegexParts = ['chrome', 'firefox', 'safari', 'opr', 'edg'].join('|');
        ...
        detect() {
          ...
          var versionRegex = this.getVersionRegex();
          var match = versionRegex.exec(this.userAgent);
...
//# sourceMappingURL=f46298cc168f0bd12520b57fb4f62d72731b6853.js.map