System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, Vec3, CCInteger, PiecesPool, EffectManager, InteractionManager, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _crd, ccclass, property, GridGenerator;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'Vec3', 'EventTouch', 'Vec2', 'CCInteger']);
      ...
      _export("GridGenerator", GridGenerator = (_dec = ccclass("GridGenerator"), _dec2 = property(_crd && PiecesPool === void 0 ? (_reportPossibleCrUseOfPiecesPool({
        ...
        constructor() {
          ...
          _initializerDefineProperty(this, "PIECE_OFFSET", _descriptor2, this);

          _initializerDefineProperty(this, "GRID_ROW", _descriptor3, this);
        ...
        start() {
          ...
          this.node.setPosition(-5 * 100, -200);
          this.generateGrid();
        }
            ...
            for (var row = 0; row < _this.GRID_ROW; row++) {
              ...
              var _loop = function _loop(col) {
                ...
                piece.on(Node.EventType.TOUCH_START, event => {
                  _this.interactionManager.onPieceClicked(event, piece, _this.gridMap);
                });
                _this.grid[row][col] = piece;
                var pieceProps = {
                  piece: piece,
      ...
      }), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "PIECE_OFFSET", [_dec3], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "GRID_ROW", [_dec4], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
//# sourceMappingURL=f4f0847fc3a2282a190c8a627d7d26253733bdd7.js.map