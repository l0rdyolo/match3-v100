    ...
    execute: function () {
      ...
      _export("GridGenerator", GridGenerator = (_dec = ccclass("GridGenerator"), _dec2 = property(Node), _dec3 = property(_crd && EasyLevels === void 0 ? (_reportPossibleCrUseOfEasyLevels({
        ...
        generate(level) {
          ...
          var tileSize = 64; // Örnek tile boyutu, kendi tile boyutunuza göre ayarlayın

          for (var row = 0; row < rows; row++) {
            for (var col = 0; col < cols; col++) {
              var tileType = gridData[row][col];
              var tilePrefab = this.tilePrefabs[tileType];

              if (tilePrefab) {
                var newTileNode = instantiate(tilePrefab);
...
//# sourceMappingURL=e43fb40d4264e3f019340dc6ad524c74119c4f3a.js.map