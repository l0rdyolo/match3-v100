        ...
        handleSelection(pieceA, pieceB) {
          ...
          return _asyncToGenerator(function* () {
            ...
            if (matches.length > 0) {
              ...
              yield _this2.fillEmptySpaces(); // const newMatches = await this.matchChecker.checkForMatchesAfterGravity(
              //   this.grid
              // );
...
//# sourceMappingURL=6c17cff11e380b31d54efae5193acb87234d5b02.js.map