  ...
  return {
    ...
    execute: function () {
      ...
      _export("GridGenerator", GridGenerator = (_dec = ccclass('GridGenerator'), _dec2 = property(_crd && PiecesPool === void 0 ? (_reportPossibleCrUseOfPiecesPool({
        ...
        start() {
          console.log(Math.round(this.GRID_ROW / 2));
          ...
          return _asyncToGenerator(function* () {
            ...
            for (var row = 0; row < _this.GRID_ROW; row++) {
              ...
              var _loop = function _loop(col) {
                ...
                piecesInRow.push(pieceProps); // await EffectManager.fallPieceToGridPosition(piece , pieceLastPosition , 0.05 ,  10)
              };
        ...
        animateRowFall(pieceProps, delay) {
          return _asyncToGenerator(function* () {
            var promises = pieceProps.map(pieceProps => {
              return (_crd && EffectManager === void 0 ? (_reportPossibleCrUseOfEffectManager({
                error: Error()
              }), EffectManager) : EffectManager).fallPieceToGridPosition(pieceProps.piece, pieceProps.targetPosition, delay, 10);
            });
        ...
        getCenteredPosition(j, i) {
          ...
          var _j = j * this.PIECE_CONTENT_SIZE - this.PIECE_CONTENT_SIZE * 5; //(Math.round(this.GRID_ROW / 2))) )


          var _i = i * this.PIECE_CONTENT_SIZE - this.PIECE_CONTENT_SIZE * 5; //(Math.round(this.GRID_ROW / 2))) ) 
...
//# sourceMappingURL=7aed1db123c78d6e5ba67193f13869d4b0e9fa75.js.map