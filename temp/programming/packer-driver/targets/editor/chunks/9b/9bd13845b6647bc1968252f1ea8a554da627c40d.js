            ...
            for (let col = 0; col < grid[0].length; col++) {
              for (let row = grid.length - 2; row >= 0; row--) {
                ...
                if (belowPiece.isEmpty && !currentPiece.isEmpty) {
                  ...
                  const currentNode = currentPiece.node; // Aşağıdaki hücreye yukarıdaki hücrenin node'unu atama

                  belowPiece.node = currentNode;
                  currentPiece.node = belowNode; // Yeni pozisyonu güncelle ve hareket ettir

                  promises.push(belowPiece.node.setPosition(new Vec3(col, row + 1, 0)));
                  moved = true;
                }
              }
            }
...
//# sourceMappingURL=9bd13845b6647bc1968252f1ea8a554da627c40d.js.map