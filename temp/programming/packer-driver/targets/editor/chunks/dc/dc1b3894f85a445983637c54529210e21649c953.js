System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, EventTarget, SingletonComponent, SliderManager, _dec, _class, _crd, ccclass, property, SelectionManager;
      ...
      _export("SelectionManager", SelectionManager = (_dec = ccclass("SelectionManager"), _dec(_class = class SelectionManager extends (_crd && SingletonComponent === void 0 ? (_reportPossibleCrUseOfSingletonComponent({
        ...
        applySelection() {
          if (this.isSelectionValid()) {
            //check Matches
            this.sliderManager.Slide(this.firstSelected, this.secondSelected);
          } else {
...
//# sourceMappingURL=dc1b3894f85a445983637c54529210e21649c953.js.map