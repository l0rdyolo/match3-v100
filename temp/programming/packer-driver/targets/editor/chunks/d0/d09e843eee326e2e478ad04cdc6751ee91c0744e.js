System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['Node', 'ParticleSystem2D', 'removeProperty', 'SpriteRenderer', 'tween', 'Vec3']);

      _export("Piece", Piece = class Piece {
        constructor(row, col, node, type) {
          this.canSelect = void 0;
          this.row = -1;
          this.col = -1;
          this.node = void 0;
          this.type = null;
        ...
        onTouch() {
          ...
          console.log(this.row, this.col, this.node.name);
        ...
        Highlight(scale = new Vec3(1.1, 1.1, 1.1)) {
...
//# sourceMappingURL=d09e843eee326e2e478ad04cdc6751ee91c0744e.js.map