    ...
    execute: function () {
      ...
      _export("GridManager", GridManager = (_dec = ccclass('GridManager'), _dec(_class = class GridManager extends (_crd && SingletonComponent === void 0 ? (_reportPossibleCrUseOfSingletonComponent({
        ...
        start() {
          ...
          const offsetDiff = -(this.gridOffset * this.gridWidth) / 2;
          const piecePositionsDiff = -(this.gridWidth * 100);
...
//# sourceMappingURL=b2ec49e522c044cb679e9e74b2ffd6e966d88a3e.js.map