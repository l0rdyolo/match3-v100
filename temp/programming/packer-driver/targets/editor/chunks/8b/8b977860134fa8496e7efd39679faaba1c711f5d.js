    ...
    execute: function () {
      ...
      _export("GridGenerator", GridGenerator = (_dec = ccclass('GridGenerator'), _dec2 = property(_crd && PiecesPool === void 0 ? (_reportPossibleCrUseOfPiecesPool({
        ...
        getCenteredPosition(j, i) {
          ...
          const _j = j * this.PIECE_CONTENT_SIZE; //- ((this.GRID_ROW / 2) )


          const _i = i * this.PIECE_CONTENT_SIZE; //- ((this.GRID_ROW / 2) ) 
...
//# sourceMappingURL=8b977860134fa8496e7efd39679faaba1c711f5d.js.map