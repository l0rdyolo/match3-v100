    ...
    execute: function () {
      ...
      _export("GridGenerator", GridGenerator = (_dec = ccclass('GridGenerator'), _dec2 = property(_crd && PiecesPool === void 0 ? (_reportPossibleCrUseOfPiecesPool({
        ...
        getCenteredPosition(j, i) {
          ...
          const _j = j * this.PIECE_CONTENT_SIZE - this.PIECE_CONTENT_SIZE * 3;

          const _i = i * this.PIECE_CONTENT_SIZE - this.PIECE_CONTENT_SIZE * 3;
...
//# sourceMappingURL=8b09cce43b0f505defb9752dbab54ec70f1006c8.js.map