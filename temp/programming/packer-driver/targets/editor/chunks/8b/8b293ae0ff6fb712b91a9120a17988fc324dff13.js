          ...
          for (let row = 0; row < this.gridHeight; row++) {
            for (let col = 0; col < this.gridWidth; col++) {
              ...
              if (piece.isEmpty) {
                ...
                piece.node.setPosition(new Vec3(piece.col, this.gridWidth * (_crd && GameGlobal === void 0 ? (_reportPossibleCrUseOfGameGlobal({
                  error: Error()
...
//# sourceMappingURL=8b293ae0ff6fb712b91a9120a17988fc324dff13.js.map