          ...
          for (let row = 0; row < this.gridHeight; row++) {
            for (let col = 0; col < this.gridWidth; col++) {
              ...
              if (piece.isEmpty) {
                ...
                piece.ResetScale();
                piece.node.setPosition(new Vec3(col, this.gridWidth * (_crd && GameGlobal === void 0 ? (_reportPossibleCrUseOfGameGlobal({
                  error: Error()
...
//# sourceMappingURL=049df720fd0b31a6887a003f25d7801cb14b1bd6.js.map