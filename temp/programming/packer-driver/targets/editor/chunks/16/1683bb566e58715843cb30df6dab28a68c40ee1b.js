    ...
    execute: function () {
      ...
      _export("GridGenerator", GridGenerator = (_dec = ccclass('GridGenerator'), _dec2 = property(_crd && PiecesPool === void 0 ? (_reportPossibleCrUseOfPiecesPool({
        ...
        getCenteredPosition(j, i) {
          ...
          const _j = j * this.PIECE_CONTENT_SIZE - this.GRID_ROW / 2 * (this.GRID_ROW * 0.75);

          const _i = i * this.PIECE_CONTENT_SIZE - this.GRID_ROW / 2 * (this.GRID_ROW * 0.75);
...
//# sourceMappingURL=1683bb566e58715843cb30df6dab28a68c40ee1b.js.map