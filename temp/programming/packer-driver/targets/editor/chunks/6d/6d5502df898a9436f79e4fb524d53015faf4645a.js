        ...
        async generateGrid() {
          ...
          for (let row = 0; row < this.GRID_ROW; row++) {
            ...
            for (let col = 0; col < this.GRID_ROW; col++) {
              ...
              const pieceFirstPosition = new Vec3(row, 500);
              ...
              await (_crd && EffectManager === void 0 ? (_reportPossibleCrUseOfEffectManager({
                error: Error()
              }), EffectManager) : EffectManager).createPiece(piece, pieceLastPosition, 0.2, (row + col) * 100);
            }
          }
        }
...
//# sourceMappingURL=6d5502df898a9436f79e4fb524d53015faf4645a.js.map