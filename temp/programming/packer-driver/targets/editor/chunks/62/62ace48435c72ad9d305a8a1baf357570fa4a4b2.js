System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Prefab, instantiate, Singleton, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, PiecePool;
  ...
  function _reportPossibleCrUseOfSingleton(extras) {
    _reporterNs.report("Singleton", "../SooLib/Optimization/Singleton", _context.meta, extras);
  }
  ...
  return {
    ...
    execute: function () {
      ...
      _export("PiecePool", PiecePool = (_dec = ccclass('PiecePool'), _dec2 = property([Prefab]), _dec(_class = (_class2 = class PiecePool extends (_crd && Singleton === void 0 ? (_reportPossibleCrUseOfSingleton({
        error: Error()
      }), Singleton) : Singleton) {
        constructor(...args) {
          super(...args);
        ...
        // İstediğiniz başlangıç boyutunu buraya koyabilirsiniz
        awakeSingleton() {
          console.log('piecePool awake');
        }
...
//# sourceMappingURL=62ace48435c72ad9d305a8a1baf357570fa4a4b2.js.map