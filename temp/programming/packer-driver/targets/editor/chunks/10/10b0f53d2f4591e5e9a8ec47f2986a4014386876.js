        ...
        async Shake(shakeAmount = 10, duration = 0.3) {
          ...
          return new Promise(resolve => {
            tween(this.node).by(duration / 4, {
              ...
              (_this$node = this.node) == null ? void 0 : _this$node.setPosition(originalPosition);
              resolve();
            }).start();
          });
        }
...
//# sourceMappingURL=10b0f53d2f4591e5e9a8ec47f2986a4014386876.js.map