    ...
    execute: function () {
      ...
      _export("GridGenerator", GridGenerator = (_dec = ccclass('GridGenerator'), _dec2 = property(_crd && PiecesPool === void 0 ? (_reportPossibleCrUseOfPiecesPool({
          ...
          for (let row = 0; row < this.GRID_ROW; row++) {
            ...
            for (let col = 0; col < this.GRID_ROW; col++) {
              ...
              await (_crd && EffectManager === void 0 ? (_reportPossibleCrUseOfEffectManager({
                error: Error()
              }), EffectManager) : EffectManager).fallPieceToGridPosition(piece, pieceLastPosition, 0.05, 10);
            }
          }
        }
        ...
        getCenteredPosition(j, i) {
          ...
          const _j = j * this.PIECE_CONTENT_SIZE - this.PIECE_CONTENT_SIZE * Math.floor(this.PIECE_CONTENT_SIZE / 2);

          const _i = i * this.PIECE_CONTENT_SIZE - this.PIECE_CONTENT_SIZE * Math.floor(this.PIECE_CONTENT_SIZE / 2);
...
//# sourceMappingURL=a4f29c0dda3cab5fe7bbadb44e7068d63e948af7.js.map