    ...
    execute: function () {
      ...
      _export("GravityHandler", GravityHandler = (_dec = ccclass('GravityHandler'), _dec(_class = class GravityHandler extends Component {
        applyGravity(matches) {
          const columnPieceCount = new Map(); // matches içindeki her bir piece için sütun sayısını hesapla

          for (const piece of matches) {
            const col = piece.col; // Eğer sütun zaten map'te varsa, sayacı artır
...
//# sourceMappingURL=a4f2d02155e46c12009770678b4c9401c142c650.js.map