          ...
          for (let row = 0; row < this.gridHeight; row++) {
            for (let col = 0; col < this.gridWidth; col++) {
              ...
              if (piece.isEmpty) {
                ...
                piece.setPosition(row, this.gridHeight + (_crd && GameGlobal === void 0 ? (_reportPossibleCrUseOfGameGlobal({
                  error: Error()
...
//# sourceMappingURL=13b60014562c7c100ac708bb4dfa9ff0ac52b4d4.js.map