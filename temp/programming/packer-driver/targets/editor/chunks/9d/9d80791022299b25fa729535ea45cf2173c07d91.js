    ...
    execute: function () {
      ...
      _export("Piece", Piece = class Piece {
        ...
        setPosition(_row, _col) {
          ...
          const piecePostion = new Vec3(row, col);
        ...
        updatePosition() {
          ...
          const newY = this.row * (_crd && GameGlobal === void 0 ? (_reportPossibleCrUseOfGameGlobal({
            error: Error()
          }), GameGlobal) : GameGlobal).PIECE_CONTENT_SIZE; // Y ekseni negatif çünkü ekranın üstünden altına doğru gidiyoruz
...
//# sourceMappingURL=9d80791022299b25fa729535ea45cf2173c07d91.js.map