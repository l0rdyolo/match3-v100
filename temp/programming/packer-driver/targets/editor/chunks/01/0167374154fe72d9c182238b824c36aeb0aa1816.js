  ...
  return {
    ...
    execute: function () {
      ...
      _export("MatchChecker", MatchChecker = (_dec = ccclass("MatchChecker"), _dec(_class = (_class2 = class MatchChecker {
        ...
        static highlightNeighbors(currentPiece, gridMap, visited, depth = 0, maxDepth = 5 // Set an appropriate max depth to prevent stack overflow
        ) {
...
//# sourceMappingURL=0167374154fe72d9c182238b824c36aeb0aa1816.js.map