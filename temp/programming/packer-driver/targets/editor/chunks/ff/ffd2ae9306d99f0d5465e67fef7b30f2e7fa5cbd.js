        ...
        async applyGravity() {
          ...
          for (let y = 0; y < cols; y++) {
            for (let x = 1; x < rows - 1; x++) {
              ...
              let piece = grid[x][y]; // Eğer hücre boşsa devam et

              if (!piece || piece.node === null) continue;
              console.log(`[${x} , ${y}] , ${piece.node.name}`);
              let newX = x; // Altındaki hücre boş olduğu sürece bu işlemi yap
...
//# sourceMappingURL=ffd2ae9306d99f0d5465e67fef7b30f2e7fa5cbd.js.map