    ...
    execute: function () {
      ...
      _export("InteractionManager", InteractionManager = (_dec = ccclass("InteractionManager"), _dec(_class = class InteractionManager extends Component {
        ...
        async onPieceClicked(event, piece, gridMap) {
          if (this.firstSelectedPiece) {
            ...
            if (diff.length() === 120) {
              ...
              if (this.checkMatches(pieceA, pieceB, gridMap)) {} else {
        ...
        checkMatches(pieceA, pieceB, gridMap) {
          const a = (_crd && MatchChecker === void 0 ? (_reportPossibleCrUseOfMatchChecker({
            error: Error()
          }), MatchChecker) : MatchChecker).checkMatches(pieceA, gridMap);
          const b = (_crd && MatchChecker === void 0 ? (_reportPossibleCrUseOfMatchChecker({
            error: Error()
...
//# sourceMappingURL=c85ba5d84da1ec13334545b492d035ebfae2fdac.js.map