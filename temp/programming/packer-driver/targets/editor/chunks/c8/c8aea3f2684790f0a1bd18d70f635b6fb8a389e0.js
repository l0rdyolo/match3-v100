        ...
        generate(level) {
          ...
          for (let row = rows - 1; row >= 0; row--) {
            for (let col = cols - 1; col >= 0; col--) {
              const currentClass = gridData[col][rows];
              ...
              if (assetType && assetType.length > 0) {
                ...
                if (randomAsset) {
                  ...
                  const position = this.getTilePosition(rows - row, cols - col, tileSize);
...
//# sourceMappingURL=c8aea3f2684790f0a1bd18d70f635b6fb8a389e0.js.map