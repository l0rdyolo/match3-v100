            ...
            for (let col = 0; col < this.gridWidth; col++) {
              ...
              if (piece.isEmpty) {
                ...
                piece.node.setPosition(new Vec3(piece.col * (_crd && GameGlobal === void 0 ? (_reportPossibleCrUseOfGameGlobal({
                  error: Error()
                }), GameGlobal) : GameGlobal).PIECE_CONTENT_SIZE, this.gridWidth * (_crd && GameGlobal === void 0 ? (_reportPossibleCrUseOfGameGlobal({
                  error: Error()
...
//# sourceMappingURL=fbd3b3be6599195a3d9cb6557c14cf0165a835b4.js.map