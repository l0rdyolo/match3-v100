    ...
    execute: function () {
      ...
      _export("GridGenerator", GridGenerator = (_dec = ccclass('GridGenerator'), _dec2 = property(_crd && PiecesPool === void 0 ? (_reportPossibleCrUseOfPiecesPool({
        ...
        getCenteredPosition(j, i) {
          ...
          const _j = j * this.PIECE_CONTENT_SIZE - 600; // - ((this.PIECE_CONTENT_SIZE * 2) )


          const _i = i * this.PIECE_CONTENT_SIZE - 600; // - ((this.PIECE_CONTENT_SIZE * 2) ) 
...
//# sourceMappingURL=938449d78aee1154f954d1966f383be16d620e2d.js.map