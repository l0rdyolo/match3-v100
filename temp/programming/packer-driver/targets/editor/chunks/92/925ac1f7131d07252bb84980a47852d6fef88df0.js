    ...
    execute: function () {
      ...
      _export("GridGenerator", GridGenerator = (_dec = ccclass('GridGenerator'), _dec2 = property(_crd && PiecesPool === void 0 ? (_reportPossibleCrUseOfPiecesPool({
        ...
        getCenteredPosition(j, i) {
          ...
          const _j = j * this.PIECE_CONTENT_SIZE - this.PIECE_CONTENT_SIZE * 5; //(Math.round(this.GRID_ROW / 2))) )


          const _i = i * this.PIECE_CONTENT_SIZE - this.PIECE_CONTENT_SIZE * 5; //(Math.round(this.GRID_ROW / 2))) ) 
...
//# sourceMappingURL=925ac1f7131d07252bb84980a47852d6fef88df0.js.map