      ...
      _export("SelectionManager", SelectionManager = (_dec = ccclass("SelectionManager"), _dec(_class = class SelectionManager extends (_crd && SingletonComponent === void 0 ? (_reportPossibleCrUseOfSingletonComponent({
        ...
        async applySelection() {
          if (this.isSelectionValid()) {
            ...
            let matches = this.matchChecker.checkForMatches(this.firstSelected, this.secondSelected); // this.gravityHandler.applyGravity(matches); 
          } else {
...
//# sourceMappingURL=51645eee02326c529286f225aee9220cac6a8ddd.js.map