System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Vec3, CCInteger, Piece, PiecesPool, InteractionManager, PieceTypes, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _crd, ccclass, property, GridGenerator;
  ...
  function _reportPossibleCrUseOfPiecesPool(extras) {
    _reporterNs.report("PiecesPool", "../Piece/PiecesPool", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      PiecesPool = _unresolved_3.PiecesPool;
    }, function (_unresolved_4) {
      InteractionManager = _unresolved_4.InteractionManager;
    }, function (_unresolved_5) {
      PieceTypes = _unresolved_5.PieceTypes;
    }],
    execute: function () {
      _crd = true;
        ...
        async Generate() {
          for (let row = 0; row < this.width; row++) {
            ...
            for (let col = 0; col < this.height; col++) {
              ...
              const piece = new (_crd && Piece === void 0 ? (_reportPossibleCrUseOfPiece({
                error: Error()
          ...
          console.log(this.grid); // for (let row = 0; row < this.GRID_ROW; row++) {
          //   this.grid[row] = [];
...
//# sourceMappingURL=3258e12070894d4711fce0f2d7c7e975541b6313.js.map