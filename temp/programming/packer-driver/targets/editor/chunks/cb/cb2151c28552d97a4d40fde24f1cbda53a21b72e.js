  ...
  return {
    ...
    execute: function () {
      ...
      _export("GridGenerator", GridGenerator = (_dec = ccclass('GridGenerator'), _dec2 = property(_crd && PiecesPool === void 0 ? (_reportPossibleCrUseOfPiecesPool({
        ...
        async animateRowFall(pieceProps, delay) {
        ...
        getCenteredPosition(j, i) {
          ...
          const _j = j * this.PIECE_CONTENT_SIZE - this.PIECE_CONTENT_SIZE * 4; //(Math.round(this.GRID_ROW / 2))) )


          const _i = i * this.PIECE_CONTENT_SIZE - this.PIECE_CONTENT_SIZE * 4; //(Math.round(this.GRID_ROW / 2))) ) 
...
//# sourceMappingURL=cb2151c28552d97a4d40fde24f1cbda53a21b72e.js.map