      ...
      _export("GridManager", GridManager = (_dec = ccclass("GridManager"), _dec(_class = class GridManager extends (_crd && SingletonComponent === void 0 ? (_reportPossibleCrUseOfSingletonComponent({
        ...
        async handleSelection(pieceA, pieceB) {
          ...
          if (matches.length > 0) {
            ...
            await this.fillEmptySpaces(); //buraya bir sleep patlar

            let newMatches = await this.matchChecker.checkForMatchesAfterGravity(this.grid);
            await this.sleep(1000); // 1 saniye bekl
...
//# sourceMappingURL=46aa7f3ca1320e4cd395e249c73ed4c31c70e839.js.map