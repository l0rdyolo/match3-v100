      ...
      _export("GridGenerator", GridGenerator = (_dec = ccclass("GridGenerator"), _dec(_class = class GridGenerator extends Component {
        ...
        generate(level) {
          ...
          for (let row = 0; row < rows; row++) {
            for (let col = 0; col < cols; col++) {
              ...
              if (assetType && assetType.length > 0) {
                ...
                if (randomAsset) {
                  ...
                  const newNode = instantiate(randomAsset); // Pozisyonunu ayarla
            ...
            const newPosition = new Vec3(-rows * 100, -cols * 100, 0);
...
//# sourceMappingURL=b95a14432548411f980631cafacb8bb30ed4a7cb.js.map