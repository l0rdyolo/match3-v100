      ...
      _export("GravityHandler", GravityHandler = (_dec = ccclass('GravityHandler'), _dec2 = property(_crd && GridManager === void 0 ? (_reportPossibleCrUseOfGridManager({
        ...
        applyGravityToCol(columnPieceCount, matches) {
          for (const [col, count] of columnPieceCount) {
            console.log(`${col} sütununu ${count} birim aşağı indirin.`); // Bu sütundaki en yüksek satırı bul (matched row'lar)

            let highestRow = this.gridManager.gridHeight - 1; // Aşağıya indirilecek parçaları bulun

            for (let i = 0; i < this.gridManager.gridHeight; i++) {
...
//# sourceMappingURL=b952ac8b944add93793bdafab2fa92fe165ee231.js.map