      ...
      _export("GridManager", GridManager = (_dec = ccclass("GridManager"), _dec(_class = class GridManager extends (_crd && SingletonComponent === void 0 ? (_reportPossibleCrUseOfSingletonComponent({
        ...
        async handleSelection(pieceA, pieceB) {
          ...
          if (matches.length > 0) {
            ...
            let matchesTest = await this.matchChecker.checkForMatches(pieceA, pieceB, this.grid);

            if (matchesTest.length > 0) {
              await this.deleteMatches(matchesTest);
...
//# sourceMappingURL=02a2f6f71e276bb2d706c6d17f4bee895a0387f7.js.map