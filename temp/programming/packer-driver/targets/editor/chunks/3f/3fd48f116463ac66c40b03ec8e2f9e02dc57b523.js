System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, EasyLevels, InGameAssets, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, GridGenerator;
        ...
        async testEffects() {
          ...
          for (let row = 0; row < levelData.rows; row++) {
            for (let col = 0; col < levelData.cols; col++) {
              ...
              const anan = (_crd && InGameAssets === void 0 ? (_reportPossibleCrUseOfInGameAssets({
                error: Error()
              }), InGameAssets) : InGameAssets).NodeMap.get(assetType);
              anan.active = true;
              return;
            }
          }
...
//# sourceMappingURL=3fd48f116463ac66c40b03ec8e2f9e02dc57b523.js.map