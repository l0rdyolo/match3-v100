    ...
    execute: function () {
      ...
      _export("GridManager", GridManager = (_dec = ccclass('GridManager'), _dec(_class = class GridManager extends (_crd && SingletonComponent === void 0 ? (_reportPossibleCrUseOfSingletonComponent({
        ...
        start() {
          ...
          this.gridWidth = this.gridGenerator.width; //! dinamik olmalı

          this.node.setPosition(new Vec3(-48 * this.gridWidth, -200, 0));
        }
...
//# sourceMappingURL=b57202fe19ecad23fe36dac1caf935534721633e.js.map