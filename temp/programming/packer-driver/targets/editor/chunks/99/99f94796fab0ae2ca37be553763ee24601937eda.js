    ...
    execute: function () {
      ...
      _export("Piece", Piece = class Piece {
        ...
        setPosition(_row, _col) {
          ...
          const piecePostion = new Vec3(col, row); // this.node.setPosition(piecePostion);
        ...
        assingPiece(node) {
          this.node = node;
          this.node.on(Node.EventType.TOUCH_START, this.onTouch, this);
          this.node.setPosition(new Vec3(0, 500, 0));
          this.particle = this.node.getComponentInChildren(ParticleSystem2D);
          this.spriteNode = this.node.getChildByName("Sprite");
          this.isMatched = false;
        }
...
//# sourceMappingURL=99f94796fab0ae2ca37be553763ee24601937eda.js.map