    ...
    execute: function () {
      ...
      _export("SelectionManager", SelectionManager = (_dec = ccclass("SelectionManager"), _dec(_class = class SelectionManager extends (_crd && SingletonComponent === void 0 ? (_reportPossibleCrUseOfSingletonComponent({
        ...
        onLoad() {
          ...
          this.eventTarget.on('applySelection', this.applySelection(), this);
          this.init();
        }
        ...
        applySelection() {
          this.eventTarget.emit('applySelection', this.firstSelected, this.secondSelected); // if(this.isSelectionValid()){
...
//# sourceMappingURL=d96570115c75559c176d163a0a8e8f16b7f6dfc7.js.map