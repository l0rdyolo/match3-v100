System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Color, Component, PoolHelper, PiecesPool, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, GameManager;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      PoolHelper = _unresolved_2.PoolHelper;
    ...
    execute: function () {
      ...
      _export("GameManager", GameManager = (_dec = ccclass('GameManager'), _dec2 = property(Color), _dec(_class = (_class2 = class GameManager extends Component {
        ...
        start() {
          console.log((_crd && PoolHelper === void 0 ? (_reportPossibleCrUseOfPoolHelper({
            error: Error()
          }), PoolHelper) : PoolHelper).get(_crd && PiecesPool === void 0 ? (_reportPossibleCrUseOfPiecesPool({
            error: Error()
...
//# sourceMappingURL=c6c2f088e67adf96874fa9490cea4146467ccf53.js.map