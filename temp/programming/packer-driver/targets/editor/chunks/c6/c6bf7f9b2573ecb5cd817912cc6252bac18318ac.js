    ...
    execute: function () {
      ...
      _export("GridManager", GridManager = (_dec = ccclass("GridManager"), _dec(_class = class GridManager extends (_crd && SingletonComponent === void 0 ? (_reportPossibleCrUseOfSingletonComponent({
        ...
        async handleSelection(pieceA, pieceB) {
          ...
          let isMatch = false;
          let matches = await this.matchChecker.checkForMatches(pieceA, pieceB, this._grid);
          ...
          for (let row = 0; row < this.gridHeight; row++) {
            ...
            for (let col = 0; col < this.gridWidth; col++) {
              ...
              if (piece.isEmpty) {
                ...
                this.node.addChild(newPieceNode); // newPieceNode.getComponentInChildren(Sprite).color =
                //   this.colors.yellow;
                ...
                piece.node.setPosition(new Vec3(piece.col * ((_crd && GameGlobal === void 0 ? (_reportPossibleCrUseOfGameGlobal({
                  ...
                  error: Error()
                }), GameGlobal) : GameGlobal).PIECE_OFFSET), this.gridWidth * (_crd && GameGlobal === void 0 ? (_reportPossibleCrUseOfGameGlobal({
                  error: Error()
...
//# sourceMappingURL=c6bf7f9b2573ecb5cd817912cc6252bac18318ac.js.map