        ...
        async onPieceClicked(event, piece, grid, gridMap) {
          if (this.firstSelectedPiece) {
            ...
            await (_crd && MatchChecker === void 0 ? (_reportPossibleCrUseOfMatchChecker({
              error: Error()
            }), MatchChecker) : MatchChecker).SwapPiecePositions(pieceA, pieceB, posA, posB); // MatchChecker.CheckSwapedPieces(pieceA , pieceB);          
          } else {
...
//# sourceMappingURL=d16bf6bcb71bd6ab6e17a4db3e2e6c10828fe46a.js.map