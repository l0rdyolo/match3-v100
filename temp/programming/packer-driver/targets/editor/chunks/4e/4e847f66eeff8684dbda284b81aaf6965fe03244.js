System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, Vec3, CCInteger, Piece, InteractionManager, PieceTypes, PiecePool, SelectionManager, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, GridGenerator;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      SelectionManager = _unresolved_6.SelectionManager;
    }],
    execute: function () {
      _crd = true;
            ...
            for (let col = 0; col < this.height; col++) {
              ...
              piece.node.on(Node.EventType.TOUCH_START, () => {
                (_crd && SelectionManager === void 0 ? (_reportPossibleCrUseOfSelectionManager({
                  error: Error()
                }), SelectionManager) : SelectionManager).Instance.onPieceSelected(piece);
              });
...
//# sourceMappingURL=4e847f66eeff8684dbda284b81aaf6965fe03244.js.map