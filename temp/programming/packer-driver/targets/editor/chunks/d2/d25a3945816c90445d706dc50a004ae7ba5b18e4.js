  ...
  return {
    ...
    execute: function () {
      ...
      _export("EffectManager", EffectManager = (_dec = ccclass("EffectManager"), _dec(_class = class EffectManager extends Component {
        ...
        static async animateRowFall(pieceProps, duration) {
          const promises = pieceProps.map(pieceProps => {
            return this.fallPieceToGridPosition(pieceProps.piece, pieceProps.targetPosition, delay, 10);
          });
...
//# sourceMappingURL=d25a3945816c90445d706dc50a004ae7ba5b18e4.js.map