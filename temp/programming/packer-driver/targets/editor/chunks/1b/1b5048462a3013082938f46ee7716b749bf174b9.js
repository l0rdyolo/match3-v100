System.register(["cc"], function (_export, _context) {
  ...
  function EnumProperty(...allowedValues) {
    return function (target, propertyKey) {
      let value = target[propertyKey];
    ...
    return function (target, propertyKey, descriptor) {
      ...
      descriptor.value = function (...args) {
        if (node) {
          ...
          if (collider) {
            collider.on('onTriggerEnter', otherCollider => {
              if (onEnter) {
            ...
            collider.on('onTriggerExit', otherCollider => {
              if (onExit) {
...
//# sourceMappingURL=1b5048462a3013082938f46ee7716b749bf174b9.js.map