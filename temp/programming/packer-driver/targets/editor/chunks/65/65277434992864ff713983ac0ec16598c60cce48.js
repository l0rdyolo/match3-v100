      ...
      _export("GridManager", GridManager = (_dec = ccclass("GridManager"), _dec(_class = class GridManager extends (_crd && SingletonComponent === void 0 ? (_reportPossibleCrUseOfSingletonComponent({
        ...
        async handleSelection(pieceA, pieceB) {
          ...
          if (matches.length > 0) {
            ...
            const newMatches = await this.matchChecker.checkForMatchesAfterGravity(this.grid); // const newMatches = await this.matchChecker.checkForMatchesAfterGravity(
            //   this.grid
            // );
          ...
          for (let row = 0; row < this.gridHeight; row++) {
            for (let col = 0; col < this.gridWidth; col++) {
              ...
              if (piece.isEmpty) {
                ...
                newPieceNode.getComponentInChildren(Sprite).color = this.colors.yellow;
...
//# sourceMappingURL=65277434992864ff713983ac0ec16598c60cce48.js.map