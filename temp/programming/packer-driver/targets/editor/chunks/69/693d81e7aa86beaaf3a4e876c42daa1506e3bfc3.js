    ...
    execute: function () {
      ...
      _export("GridManager", GridManager = (_dec = ccclass("GridManager"), _dec(_class = class GridManager extends (_crd && SingletonComponent === void 0 ? (_reportPossibleCrUseOfSingletonComponent({
        ...
        SwapPieces(pieceA, pieceB) {
          ...
          pieceA.col = pb_col;
          pieceB.col = pa_col;
          this._grid[pa_row][pa_col] = null;
          this._grid[pb_row][pb_col] = null;
          this._grid[pa_row][pa_col] = pieceB;
          this._grid[pb_row][pb_col] = pieceA;
...
//# sourceMappingURL=693d81e7aa86beaaf3a4e876c42daa1506e3bfc3.js.map