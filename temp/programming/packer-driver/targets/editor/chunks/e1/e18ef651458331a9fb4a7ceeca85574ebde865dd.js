    ...
    execute: function () {
      ...
      _export("GridManager", GridManager = (_dec = ccclass("GridManager"), _dec(_class = class GridManager extends (_crd && SingletonComponent === void 0 ? (_reportPossibleCrUseOfSingletonComponent({
        ...
        async handleSelection(pieceA, pieceB) {
          ...
          let matches = await this.matchChecker.checkForMatches(pieceA, pieceB);

          if (matches.length > 0) {
            await this.deleteMatches(matches);
            await this.gravityHandler.applyGravity();
            await this.fillEmptySpaces();
            let afterMatches = await this.matchChecker.checkForMatchesAfterGravity();
...
//# sourceMappingURL=e18ef651458331a9fb4a7ceeca85574ebde865dd.js.map