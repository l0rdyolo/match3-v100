    ...
    execute: function () {
      ...
      _export("GridManager", GridManager = (_dec = ccclass("GridManager"), _dec(_class = class GridManager extends (_crd && SingletonComponent === void 0 ? (_reportPossibleCrUseOfSingletonComponent({
        ...
        async SwapPieces(pieceA, pieceB) {
          // Öncelikle iki parçanın pozisyonlarını değiştirmek için bir animasyon veya hareket işlemi başlatıyoruz.
          await this.sliderManager.Slide(pieceA, pieceB); // Temp bir değişken kullanarak node'ları takas edelim

          const tempNode = pieceA.node;
          pieceA.node = pieceB.node;
          pieceB.node = tempNode; // Grid'deki yerleşimlere dokunmuyoruz, sadece node'lar değiştiriliyor.
        }
...
//# sourceMappingURL=7ede435c4a8d3a399fc54d2dc7d5952d802a44ae.js.map