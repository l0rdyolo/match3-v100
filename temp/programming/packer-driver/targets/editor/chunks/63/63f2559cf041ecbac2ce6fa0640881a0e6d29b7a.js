    ...
    execute: function () {
      ...
      _export("VerticalMatchStrategy", VerticalMatchStrategy = class VerticalMatchStrategy {
        ...
        checkMatch(pieceA, pieceB) {
          ...
          const pieces = this.checkSinglePieceMatch(pieceA, grid);
          let matchesB = this.checkSinglePieceMatch(pieceB, grid);
          matchesB = matchesB.concat(pieces);
          return matchesB;
          ;
        }
...
//# sourceMappingURL=63f2559cf041ecbac2ce6fa0640881a0e6d29b7a.js.map