  ...
  return {
    ...
    execute: function () {
      ...
      _export("Piece", Piece = class Piece {
        ...
        onTouch() {
          console.log((_crd && SelectionManager === void 0 ? (_reportPossibleCrUseOfSelectionManager({
            error: Error()
          }), SelectionManager) : SelectionManager).eventTarget);
          (_crd && SelectionManager === void 0 ? (_reportPossibleCrUseOfSelectionManager({
            error: Error()
          }), SelectionManager) : SelectionManager).eventTarget.emit('piece-selected', this);
        }
...
//# sourceMappingURL=a640b50448c709d28988976c97677ae27470d5da.js.map