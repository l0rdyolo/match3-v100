    ...
    execute: function () {
      ...
      _export("GridGenerator", GridGenerator = (_dec = ccclass('GridGenerator'), _dec2 = property(_crd && PiecesPool === void 0 ? (_reportPossibleCrUseOfPiecesPool({
        ...
        getCenteredPosition(j, i) {
          ...
          const _j = j * this.PIECE_CONTENT_SIZE - this.PIECE_CONTENT_SIZE * Math.round(this.GRID_ROW / 2);

          const _i = i * this.PIECE_CONTENT_SIZE - this.PIECE_CONTENT_SIZE * Math.round(this.GRID_ROW / 2);
...
//# sourceMappingURL=1f8231eef33064ede5802b87e4a2e80309dde3d3.js.map