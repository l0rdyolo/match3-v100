System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Vec3, CCInteger, PiecesPool, InteractionManager, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _crd, ccclass, property, GridGenerator;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("GridGenerator", GridGenerator = (_dec = ccclass("GridGenerator"), _dec2 = property(_crd && PiecesPool === void 0 ? (_reportPossibleCrUseOfPiecesPool({
        ...
        async generateGrid() {// for (let row = 0; row < this.GRID_ROW; row++) {
          //   this.grid[row] = [];
...
//# sourceMappingURL=1f7cefd0246840bc4852310227786b9e57f4a970.js.map